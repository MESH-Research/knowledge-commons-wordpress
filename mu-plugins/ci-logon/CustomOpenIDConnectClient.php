 ...
 *
 */
class CustomOpenIDConnectClient
{
    ...
    private function requestAuthorization() {
        ...
        // this custom class requires that state is set and controlled by the application itself
        // hence we do not, anymore, generate the state here
