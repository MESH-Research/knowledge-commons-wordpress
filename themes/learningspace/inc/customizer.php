...
function wp_bootstrap_starter_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'instructor_info',
        array(
            'title' => __( 'Instructor Info', 'wp-bootstrap-starter' ),
            'priority' => 20,
        )
    );
    ...
    $wp_customize->remove_section( 'header_banner_visibility' );
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Course Card Background Color', 'wp-bootstrap-starter' ),
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_title_setting', array(
        'label' => __( 'Instructor Name', 'wp-bootstrap-starter' ),
        'section'    => 'instructor_info',
    ...
    $wp_customize->add_setting( 'header_banner_title_setting', array(
        'default' => __( 'Add your name at Dashboard - Appearance - Customize','wp-bootstrap-starter' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );

    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'Instructor E-mail (Add or delete this in the customizer)', 'wp-bootstrap-starter' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Instructor E-mail', 'wp-bootstrap-starter' ),
        'section'    => 'instructor_info',
