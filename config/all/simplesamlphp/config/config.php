...
$_requested_domain_base = match (true) {
    ...
    default => implode('.', array_slice(explode('.', $_requested_domain), -2)),
};
...
$config = [
     ...
     * root directory.
     */
    'certdir' => '/app/config/all/simplesamlphp/cert/',
    'loggingdir' => '/app/config/all/simplesamlphp/log/',
    'datadir' => '/app/config/all/simplesamlphp/data/',
    'tempdir' => '/app/config/all/simplesamlphp/tmp/',
     ...
     */
    'metadatadir' => '/app/config/all/simplesamlphp/metadata',
     ...
     */
    'store.redis.host' => getenv('WP_REDIS_HOST'),
